...
import json
class CreateArgs():
    def __init__(self, capacity=2097152, zoneid=1, remarks="jmisstest", space_name="jmisstest", space_type=1, quantity=1):
...
class WebClient(object):
    ...
    def __init__(self, host, port, md5_pin, auth_token):
        self.host = host
        self.port = port
