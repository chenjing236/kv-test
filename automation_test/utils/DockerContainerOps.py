...
def stop_slave(space_id,slave_ip,slave_port,container_daemon):
    '''
    ...
    c = Client(base_url=docker_server,version=docker_version)
...
#   container_daemon,slave所在Docker的守护进程的PORT
def stop_master(space_id,master_ip,master_port,container_daemon):
    '''
    :param slave_ip,slave_port,container_daemon:
    :return: []
    '''
