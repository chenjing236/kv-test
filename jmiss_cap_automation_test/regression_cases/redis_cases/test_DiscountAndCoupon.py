...
class TestDiscountAndCoupon:
    ...
    @pytest.mark.smoke
    def test_discount_and_coupon(self, config, instance_data, redis_http_client, cap_http_client):
        ...
        query_available_coupons_step(config, instance_data, cap.httpClient, instance_data['redis_coupon_info'])
