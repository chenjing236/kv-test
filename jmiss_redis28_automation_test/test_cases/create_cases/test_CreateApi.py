...
class TestCreateApi:
    ...
    def test_create_with_empty_vpc_id(self, config, instance_data):
        # 创建缓存云实例
    ...
    @pytest.mark.regression
    def test_create_with_error_vpc_id(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_empty_subnet_id(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_error_subnet_id(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_empty_instance_class(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_error_instance_class(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_empty_name(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_name_shorter_than_2(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_name_longer_than_32(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_name_include_special_signal(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_remarks_longer_than_256(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_pwd_shorter_than_8(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_pwd_longer_than_16(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_pwd_not_contain_capital_letters(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_pwd_not_contain_lowercase_letters(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
        create_params["password"] = "1QAZ2WSX"
    ...
    @pytest.mark.regression
    def test_create_with_pwd_not_contain_numbers(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_empty_az_id(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
        create_params["azId"] = {}
    ...
    @pytest.mark.regression
    def test_create_with_empty_master_az_id(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_empty_slave_az_id(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_error_az_id(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_error_redis_version(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_error_charge_mode(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_error_charge_unit(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
    ...
    @pytest.mark.regression
    def test_create_with_error_charge_duration(self, config, instance_data):
        # 创建缓存云实例
        redis_cap = RedisCap(config, instance_data)
        create_params, charge_params = get_create_params(instance_data)
