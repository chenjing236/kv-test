...
def check_all_admin(instanceId, config, excepted):
    ...
    if isCurrect:
        raise ValueError(
            "check is_first_start error,exceptedis_first_start=%s,actual is_first_start=%s" % excepted["is_first_start"],
            actual)
    ...
    if isCurrect:
        raise ValueError(
            "check failovering_num error,exceptedfailovering_num=%s,actual failovering_num=%s" % excepted["failovering_num"],
            actual)
